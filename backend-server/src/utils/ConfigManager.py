...
class ConfigManager:
    ...
    def get_all(self, category: Optional[str] = None) -> Dict[str, ConfigItem]:
        """
        获取所有配置
    ...
    def import_config(self, config_dict: Dict[str, Any], updated_by: Optional[str] = None):
        """
        导入配置
...
def set_config(key: str, value: Any, updated_by: Optional[str] = None) -> bool:
    """便捷函数：设置配置"""
