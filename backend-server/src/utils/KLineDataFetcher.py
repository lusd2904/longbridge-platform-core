...
class KLineDataFetcher:
    ...
    def generate_all_kline_data(self):
        ...
        return {"weekly": weekly_count, "monthly": monthly_count, "yearly": yearly_count}
