...
class AIAnalyzer:
    ...
    def ai_deep_analysis(shortlist, summary_data, holds):
        ...
        for target in targets:
            ...
            MonitorLink.log(
                f"   [数据提取] 价格: {stock_data['price']}, RSI: {stock_data['rsi']}, KDJ: {stock_data['kdj']}, CCI: {stock_data['cci']}"
            )
    ...
    def _extract_stock_data(summary_data, target):
        ...
        return {"price": curr_p, "rsi": rsi, "kdj": kdj_k, "cci": cci, "macd": macd_h, "atr": atr, "roc": roc}
