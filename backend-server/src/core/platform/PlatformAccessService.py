...
class PlatformAccessService:
    ...
    ROLE_SEEDS = [
        ...
        },
        {
            ...
            "priority": 30,
            "capabilities": ["market.view", "market.detail.view", "market.sentiment.view"],
        },
        {
            "role_code": "trader",
            "role_name": "交易用户",
    ...
    MENU_SEEDS = [
        ...
        },
        {
            ...
            "icon": "Wallet",
            "sort_index": 20,
            "required_capability": "trade.live",
        },
        {
            "menu_code": "positions",
            "title": "持仓管理",
            ...
            "icon": "Coin",
            "sort_index": 30,
            "required_capability": "positions.view",
        },
        {
            "menu_code": "orders",
            "title": "订单管理",
        ...
        {
            "menu_code": "stock-pool",
            "title": "股票池",
            "route_name": "StockPool",
            "route_path": "/stock-pool",
            "menu_group": "analysis",
            "subsystem_code": "market",
            "icon": "Collection",
            "sort_index": 50,
            "required_capability": "stock.pool.view",
        },
        {
            "menu_code": "watchlist-pool",
            "title": "自选股票池",
            "route_name": "WatchlistPool",
            "route_path": "/watchlist-pool",
            "menu_group": "analysis",
            "subsystem_code": "market",
            "icon": "Star",
            "sort_index": 55,
        ...
        {
            "menu_code": "watchlist-ai-trade-runs",
            "title": "AI交易扫描记录",
            "route_name": "WatchlistAiTradeRuns",
            "route_path": "/watchlist-ai-trade-runs",
            "menu_group": "analysis",
            "subsystem_code": "market",
            "icon": "DataLine",
            "sort_index": 58,
        ...
        {
            "menu_code": "ai-analysis",
            "title": "AI研判",
            "route_name": "AIAnalysis",
            "route_path": "/ai-analysis",
            "menu_group": "analysis",
            "subsystem_code": "analysis",
            "icon": "Cpu",
            "sort_index": 60,
            "required_capability": "ai.analysis",
        },
        {
            "menu_code": "strategy",
            "title": "策略管理",
        ...
        },
        {
            ...
            "icon": "DataLine",
            "sort_index": 80,
            "required_capability": "strategy.backtest",
        },
        {
            "menu_code": "risk",
            "title": "风控管理",
            "route_name": "RiskManagement",
            "route_path": "/risk",
            "menu_group": "risk",
            "subsystem_code": "trading",
            "icon": "Warning",
            "sort_index": 90,
            "required_capability": "risk.manage",
        },
        {
            "menu_code": "market",
            "title": "实时行情",
            "route_name": "MarketData",
            "route_path": "/market",
            "menu_group": "market",
            "subsystem_code": "market",
            "icon": "Histogram",
            "sort_index": 100,
            "required_capability": "market.view",
        },
        {
            "menu_code": "kline",
            "title": "历史K线",
            ...
            "icon": "TrendCharts",
            "sort_index": 110,
            "required_capability": "market.detail.view",
        },
        {
            "menu_code": "recommendations",
            "title": "智能推荐",
            "route_name": "Recommendations",
            "route_path": "/recommendations",
            "menu_group": "market",
            "subsystem_code": "market",
            "icon": "Star",
            "sort_index": 120,
            "required_capability": "recommendations.view",
        },
        {
            "menu_code": "sentiment-center",
            "title": "市场舆情",
            "route_name": "MarketSentiment",
            "route_path": "/sentiment-center",
            "menu_group": "market",
            "subsystem_code": "market",
            "icon": "Cpu",
            "sort_index": 125,
            "required_capability": "market.sentiment.view",
        },
        {
            "menu_code": "finance-news",
            "title": "财经快讯",
            "route_name": "FinanceNews",
            "route_path": "/finance-news",
            "menu_group": "market",
            "subsystem_code": "market",
            "icon": "Bell",
            "sort_index": 130,
            "required_capability": "market.news.view",
        },
        {
            "menu_code": "profile",
            "title": "个人中心",
            ...
            "icon": "User",
            "sort_index": 140,
            "required_capability": "profile.view",
        },
        {
            "menu_code": "broker-management",
            "title": "券商连接",
            "route_name": "BrokerManagement",
            "route_path": "/broker-management",
            "menu_group": "user",
            "subsystem_code": "platform",
            "icon": "Wallet",
            "sort_index": 145,
        ...
        {
            "menu_code": "scheduler-center",
            "title": "任务中心",
            "route_name": "SchedulerCenter",
            "route_path": "/scheduler-center",
            "menu_group": "system",
            "subsystem_code": "platform",
            "icon": "Timer",
            "sort_index": 180,
            "required_capability": "tasks.manage",
        },
        {
            "menu_code": "history-coverage",
            "title": "历史补价覆盖",
            "route_name": "HistoryCoverage",
            "route_path": "/history-coverage",
            "menu_group": "system",
            "subsystem_code": "platform",
            "icon": "DataLine",
            "sort_index": 185,
    ...
    def _ensure_platform_schema_columns(cls) -> None:
        cls._ensure_column(
            "platform_menus", "subsystem_code", "VARCHAR(32) DEFAULT 'workspace' COMMENT '所属子系统编码'"
        )
    ...
    def _cleanup_obsolete_roles(cls) -> None:
        ...
        DbUtil.execute_sql(f"DELETE FROM platform_role_menus WHERE role_code IN ({placeholders})", obsolete_role_codes)
        DbUtil.execute_sql(
            f"DELETE FROM platform_roles WHERE is_system = 1 AND role_code IN ({placeholders})", obsolete_role_codes
        )
        ...
        for role_code, capabilities in role_caps.items():
            for menu in cls.MENU_SEEDS:
                can_view = (
                    1
                    if (
                        not menu["required_capability"]
                        or menu["required_capability"] in capabilities
                        or role_code == "admin"
                    )
                    else 0
                )
    ...
    def list_roles(cls) -> list[dict[str, object]]:
        ...
        menu_capability_map = {
            str(item.get("code") or ""): str(item.get("requiredCapability") or "").strip() for item in menus
        }
        all_menu_capabilities = {capability for capability in menu_capability_map.values() if capability}
    ...
    def upsert_role(
        ...
        selected_menu_codes = [
            code
            for code in (menu_codes if menu_codes is not None else cls._role_menu_map().get(normalized_role_code, []))
            if code in menu_capability_map
        ]
        preserved_extra_capabilities = (
            {str(item).strip() for item in (extra_capabilities or []) if str(item or "").strip()}
        ...
        capabilities = sorted(
            {menu_capability_map[code] for code in selected_menu_codes if menu_capability_map.get(code)}.union(
                preserved_extra_capabilities
            )
        )
        next_is_system = int(
            bool(current_row.get("is_system")) if is_system is None and current_row else bool(is_system)
        )
        ...
        for menu_code in all_menu_codes:
            DbUtil.execute_sql(
                ...
                ON DUPLICATE KEY UPDATE
                    ...
                    updated_at = CURRENT_TIMESTAMP
                """,
                (normalized_role_code, menu_code, 1 if menu_code in selected_menu_code_set else 0),
            )
    ...
    @classmethod
    def get_user_record(cls, user_id: int) -> dict[str, object] | None:
        cls.ensure_schema()
    ...
    @classmethod
    def _build_user_capabilities(cls, user_id: int, record: dict[str, object] | None) -> dict[str, object]:
        if not record:
            return {
        ...
        role_row = (
            DbUtil.fetch_one("SELECT capabilities_json FROM platform_roles WHERE role_code = %s LIMIT 1", (role_code,))
            or {}
        )
        ...
        can_use_quant = (
            has_bound_account
            and bool(record.get("quant_api_enabled"))
            and ("quant.use" in dynamic_caps or role_code == "admin")
        )
    ...
    @classmethod
    def get_user_subsystems(cls, user_id: int, menus: list[dict[str, object]] | None = None) -> list[dict[str, object]]:
        cls.ensure_schema()
        ...
        for row in subsystem_rows:
            ...
            landing_menu = next(
                (item for item in related_menus if item.get("routeName") == preferred_route_name), related_menus[0]
            )
    ...
    @classmethod
    def invalidate_bootstrap_cache(cls, user_id: int | None = None) -> None:
    ...
    def _build_user_bootstrap_bundle_uncached(
        ...
        preferred_subsystem_code = (
            str(record.get("preferred_subsystem_code") or access.get("preferredSubsystemCode") or "workspace").strip()
            or "workspace"
        )
        ...
        return (
            {
                ...
                "navigation": {"homePath": home_path, "preferredSubsystemCode": preferred_subsystem_code},
            },
            record,
        )
    ...
    def update_user_access(
        ...
        quant_api_enabled: bool | None = None,
        task_admin_enabled: bool | None = None,
        preferred_subsystem_code: str | None = None,
    ) -> None:
        cls.ensure_schema()
        updates = []
        params: list[object] = []
        ...
        DbUtil.execute_sql(f"UPDATE users SET {', '.join(updates)} WHERE id = %s", tuple(params))
