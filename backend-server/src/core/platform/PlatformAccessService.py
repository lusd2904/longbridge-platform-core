...
class PlatformAccessService:
    ...
    MENU_SEEDS = [
        ...
        {"menu_code": "watchlist-ai-trade-runs", "title": "AI交易扫描记录", "route_name": "WatchlistAiTradeRuns", "route_path": "/watchlist-ai-trade-runs", "menu_group": "analysis", "subsystem_code": "market", "icon": "DataLine", "sort_index": 58, "required_capability": "stock.pool.view"},
