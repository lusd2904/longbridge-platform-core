...
class RiskManager:
    ...
    def check_order_risk(self, 
                        ...
                        price: float,
                        account_info: Dict,
                        positions: List[Dict]) -> Tuple[bool, str, RiskLevel]:
        """
        检查订单风险
    ...
    def check_stop_loss(self, 
                       ...
                       current_price: float,
                       entry_price: float,
                       position_quantity: int) -> Tuple[bool, str, float]:
        """
        检查是否需要止损
    ...
    def calculate_position_size(self,
        ...
        logger.info(f"仓位计算 - {symbol}: 基于风险={position_by_risk}, 基于限制={position_by_limit}, 建议={suggested_quantity}")
