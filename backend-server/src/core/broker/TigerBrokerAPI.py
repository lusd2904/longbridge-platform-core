...
from core.broker.BrokerInterface import AccountInfo, Order, Position
...
class TigerBrokerAPI:
    ...
    def __init__(self, account_id: int | None = None):
        ...
        self.config: TigerAccountConfig | None = None

        # API客户端
        self.client: TigerOpenClient | None = None
        self.quote_client: QuoteClient | None = None
        self.trade_client: TradeClient | None = None
        ...
        try:
            ...
            try:
                ...
                self.client_config = get_client_config(
                    private_key_path=temp_key_path, tiger_id=self.config.tiger_id, account=self.config.account
                )
    ...
    def get_klines(self, symbol: str, period: str = "day", limit: int = 100) -> list[dict]:
        ...
        try:
            ...
            # 获取K线
            klines = self.quote_client.get_klines(symbols=[symbol], period=tiger_period, limit=limit)
        ...
        try:
            ...
            if accounts and len(accounts) > 0:
                ...
                if summary:
                    ...
                    logger.info(
                        f"账户数据: cash={cash}, buying_power={buying_power}, "
    ...
    def place_order(
        ...
        try:
            # 转换订单类型
            from tigeropen.common.const import OrderSide, OrderType, TimeInForce
        ...
        try:
            ...
            for o in orders:
                order = Order(
                    ...
                    price=float(getattr(o, "price", getattr(o, "submitted_price", getattr(o, "limit_price", 0))) or 0),
...
# 便捷函数
def get_tiger_api(account_id: int | None = None) -> TigerBrokerAPI:
    """获取老虎证券API实例"""
